...
@MODELS.register_module("PG-v3m2")
class PointGroup(nn.Module):
    def __init__(
        ...
        self.seg_head = nn.Sequential(
            ...
            norm_fn(backbone_out_channels),
            nn.ReLU(),
            nn.Linear(backbone_out_channels, semantic_num_classes+1),
        )
    ...
    def loss(self, logit_pred, bias_pred, data_dict):
        ...
        logit_pred = logit_pred[:, :self.semantic_num_classes]
    ...
    def pred_feat(self, logit_pred, bias_pred, data_dict):
        ...
        segment_pred[segment_pred == self.semantic_num_classes] = torch.tensor(self.segment_ignore_index)
